<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $username = strtolower($input_username);
        ...
        if( $password != $confirm_password){
            ...
            $query = "INSERT INTO login (Username, Password) VALUES ('$username', '$query_pass')";
            $result = mysqli_query($connection, $query);
            if(!$result){
       ...
       <div id="mySidenav" class="sidenav">
        ...
        <form action="signup.php" method="post">
            ...
            <div class="container">
                ...
                <label for="user_cpass" id="confirm_password" style="display: block;
                color: rgba(0, 0, 0, 0.6);
                font-size: 12px;
                font-weight: 500;
                margin-left: 2;
                margin-left: 22px;
                text-transform: uppercase;
                letter-spacing: .2em;">Confirm password</label>
                <input type="password" placeholder="Enter Password" name="confirm_password"  required=""><br>
                <button type="submit" name="submit">Sign up</button><br>
            </div><br>
            <b>Already a member?</b><a href="login.php"><b>Log In</b></a>
